...
var (
	...
	requirementsText = map[string]string{
		...
		"CLOUDFLARE_R2_ENDPOINT":      "CLOUDFLARE_R2_ENDPOINT: Set up a Cloudflare account",
		"CLOUDFLARE_R2_ACCESS_KEY_ID": "CLOUDFLARE_R2_ACCESS_KEY_ID: Set up a Cloudflare account",
		"CLOUDFLARE_R2_SECRET_KEY":    "CLOUDFLARE_R2_SECRET_KEY: Set up a Cloudflare account",
	}
)
