  ...
  class UtilsTest < Minitest::Test
    ...
    def setup
      ...
      @source1 = [
        ...
        { name: "Bob Jones", positions: ["Council Member"], email: "bob.jones@example.com", phone: "555-123-4567",
          website: "bob.com" }
      ]

      @source2 = [
        { name: "Alice Smith", positions: ["Mayor"], email: "alice.smith@example.com", phone: "1234567890",
          website: "alice.com" },
        { name: "Bob Jones", positions: ["Councilman"], email: "bob.jones@example.com", phone: "555-123-4567",
          website: "bob-jones.com" }
      ]

      @source3 = [
        { name: "Alice Smith", positions: ["Mayor"], email: "alice.smith@example.com", phone: "123-456-7890",
          website: "alice.org" },
        { name: "Bob Jones", positions: ["Council Member"], email: "bob.jones@example.com", phone: "555-123-4567",
          website: "bob.com" }
      ]
    ...
    def test_similarity_exact_match
      assert_equal 1.0, Validators::Utils.similarity_score(:phone, "123-456-7890", "123-456-7890")
    ...
    def test_similarity_phone_normalization
      assert_equal 1.0, Validators::Utils.similarity_score(:phone, "123-456-7890", "1234567890")
      assert_equal 0.0, Validators::Utils.similarity_score(:phone, "123-456-7890", "987-654-3210")
    end

    def test_similarity_email_gmail_normalization
      assert_equal 1.0, Validators::Utils.similarity_score(:email, "alice.smith@gmail.com", "alicesmith@gmail.com")
