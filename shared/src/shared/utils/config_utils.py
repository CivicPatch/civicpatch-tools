...
def get_keywords() -> List[str]:
    role_keywords = set(get_role_alias_map().keys()) | set(get_role_alias_map().values())
    designation_keywords = set(get_designation_alias_map().keys()) | set(get_designation_alias_map().values())
    extra_keywords = [
