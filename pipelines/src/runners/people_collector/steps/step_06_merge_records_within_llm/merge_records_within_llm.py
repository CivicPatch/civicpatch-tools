...
import runners.people_collector.steps.step_06_merge_records_within_llm.field_mergers as field_mergers
...
def merge_records_within_llm(context: PeopleCollectorContext) -> MergeRecordsWithinLLMStep:
    ...
    roles_to_keep = set(r.lower() for r in config_utils.get_role_names(context.data.role_config))
