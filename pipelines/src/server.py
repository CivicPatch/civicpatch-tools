...
def _cap(config_data: dict) -> Optional[Decimal]:
    """Null, absent, or empty all mean the same thing: inherit `pipeline.yml`'s default."""
    raw = config_data.get("pipeline_run_cap_usd")
