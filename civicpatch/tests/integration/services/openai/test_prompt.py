import pytest
from services.openai.llm import run_prompt
from services.openai.prompts import municipality_officials_prompt
...
@pytest.mark.asyncio
async def test_run_prompt_mount_laurel_without_people():
