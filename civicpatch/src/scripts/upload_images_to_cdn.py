...
def main():
    if len(os.sys.argv) != 2:
        ...
        os.sys.exit(1)
    elif any([STORAGE_ACCESS_KEY_ID is None, STORAGE_SECRET_ACCESS_KEY is None, STORAGE_ENDPOINT is None]):
        print("STORAGE_ACCESS_KEY_ID, STORAGE_SECRET_ACCESS_KEY, and STORAGE_ENDPOINT must be set in environment variables.")
        os.sys.exit(1)
